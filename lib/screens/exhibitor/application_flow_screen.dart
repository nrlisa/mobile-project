...
class _ApplicationFlowScreenState extends State<ApplicationFlowScreen> {
  ...
  Map<String, String>? _applicationData;
  ...
  Widget build(BuildContext context) {
    ...
    String appBarTitle = "Book a Booth";
    if (_currentStep == 0) appBarTitle = "Select Event";
    if (_currentStep == 1) appBarTitle = "Select Booth";
    if (_currentStep == 2) appBarTitle = "Application Form";
        ...
        return BoothSelection(
          ...
          onBoothSelected: (boothId) {
            setState(() {
              ...
              _currentStep = 1; // Staying on step 1 visually but updating logic
        ...
        return ApplicationForm(
          ...
          onFormSubmitted: (data) {
            setState(() {
              ...
              _currentStep = 3; // Move to Review & Submit
            });
          },
        );
      default:
        return const Center(child: Text("Review & Submit Page Coming Soon"));
    }
  }
